...
const TEST_URLS = [
  ...
  {
    url: `${BASE_URL}/feedback/4?version=opt4-scheduler`,
    name: 'Opt4: RenderScheduler (K=4)',
    shortName: 'opt4-scheduler'
  },
  {
    url: `${BASE_URL}/feedback/4?version=opt5-raf-batching`,
    name: 'Opt5: RAF 배칭',
    shortName: 'opt5-raf-batching'
  },
  {
    url: `${BASE_URL}/feedback/4?version=opt6-priority`,
    name: 'Opt6: 우선순위 정렬',
    shortName: 'opt6-priority'
  },
  {
    url: `${BASE_URL}/feedback/4?version=opt7-all-scheduling`,
    name: 'Opt7: 전체 스케줄링',
...
(async () => {
  console.log('\n🚀 PDF 첫페이지 렌더링 성능 벤치마크 - 그룹2 (Opt 4,5,6,7 + 기준선)');
  ...
  const outputPath = path.join(outDir, `pdf-firstpage-group2-${timestamp}.json`);
