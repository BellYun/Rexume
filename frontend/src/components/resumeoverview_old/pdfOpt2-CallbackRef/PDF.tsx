...
const PDF = forwardRef<HTMLDivElement, PDFProps>(({
  ...
  const renderPage = useCallback(async () => {
    ...
    try {
      console.log(`[Opt2-CallbackRef] Starting render for page ${pageNumber}`);
      ...
      console.log(`[pdfOpt2-CallbackRef] 페이지 ${pageNumber} 렌더링 완료: ${metrics.totalMs.toFixed(1)}ms`);
  ...
  const setHostRef = useCallback(
    (el: HTMLDivElement | null) => {
      ...
      console.log(`Page ${pageNumber}: renderPage function attached (Opt2-CallbackRef)`);
