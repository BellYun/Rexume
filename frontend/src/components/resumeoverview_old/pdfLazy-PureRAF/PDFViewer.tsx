...
const PDFViewer = ({
  ...
  useEffect(() => {
    ...
    const margin =
      typeof window !== "undefined" ? Math.round(window.innerHeight * 0.75) : 1200;
    ...
    observerRef.current = new IntersectionObserver(
      ...
      { root: null, threshold: 0, rootMargin: `${margin}px 0px` }
    );
  ...
  return (
    <div style={{ width: 1200, margin: "auto", overflowY: "auto", maxHeight: "90vh" }}>
